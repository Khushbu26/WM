					...
					<div class="col-lg-12">
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">EDIT EVENTS</h2>
							</header>
							<div class="panel-body">
								<c:forEach items="${sessionScope.editEvent }" var="x">
									<form class="form-horizontal form-bordered"
										action="<%=request.getContextPath()%>/EventController"
										method="post">
										<div class="form-group">
											<label class="col-md-3 control-label">Event Name <span
												class="required"></span></label>
											<div class="col-md-6">
												<input type="text" name="event_name" value="${x.eventName}"
													class="form-control" placeholder="Enter Event Name here"
													required />
											</div>
										</div>
										<div class="form-group">
											<label class="col-md-3 control-label" for="textareaAutosize">Event
												Description</label>
											<div class="col-md-6">
												<textarea name="event_des" class="form-control" rows="3"
													id="textareaAutosize"
													placeholder="Enter Event Description here"
													data-plugin-textarea-autosize>${x.eventDes }</textarea>
											</div>
										</div>

										<div class="form-group">
											<label class="col-md-3 control-label">Event Duration</label>
											<div class="col-md-6">
