...
<title>Search Road Side Unit</title>
			...
			<section role="main" class="content-body">
				...
				<section class="panel">
					<header class="panel-heading">
						...
						<h2 class="panel-title">Search Road Side Unit</h2>
					</header>
							...
							<div class="table-responsive">
								<table
									...
									<thead>
										<tr role="row">
											<th class="sorting" tabindex="0"
												aria-controls="datatable-editable" rowspan="1" colspan="1">Dustbin</th>
											<th class="sorting" tabindex="0"
											...
											<th class="sorting" tabindex="0"
												aria-controls="datatable-editable" rowspan="1" colspan="1">Longitude</th>
											<th class="sorting" tabindex="0"
												aria-controls="datatable-editable" rowspan="1" colspan="1">Latitude</th>
											<th class="sorting" tabindex="0"
									...
									<tbody>
										...
										<c:forEach items="${sessionScope.road }" var="x">
											<tr>
												<td>${x.dustbinRef.dustName}</td>
											...
											<a href="<%=request.getContextPath() %>/RoadsideunitController?flag=edit&id=${x.roadId}" class="btn" rel="tooltip" title="Edit">
									<i class="fa fa-edit"></i>
								</a>
								<a href="<%=request.getContextPath() %>/RoadsideunitController?flag=delete&id=${x.roadId}" class="btn" rel="tooltip" title="Delete">
