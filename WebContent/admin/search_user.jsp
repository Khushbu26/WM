			...
			<section role="main" class="content-body">
				...
				<section class="panel">
					<header class="panel-heading">
						...
						<h2 class="panel-title">Search User</h2>
					</header>
									...
									<thead>
										<tr role="row">
											<th class="sorting" tabindex="0"
												aria-controls="datatable-editable" rowspan="1" colspan="1">First
												Name</th>
											<th class="sorting" tabindex="0"
												aria-controls="datatable-editable" rowspan="1" colspan="1">Last
												Name</th>
											<th class="sorting" tabindex="0"
