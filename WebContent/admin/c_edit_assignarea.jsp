...
<body>
	<section class="body">
		...
		<div class="inner-wrapper">
			...
			<!-- end: sidebar -->
			<c:forEach items="${sessionScope.editAssignArea }" var="y">
			<form action="<%=request.getContextPath()%>/CAssignAreaController" method="POST">
				<section role="main" class="content-body">
					...
					<header class="panel-heading">
						...
						<h2 class="panel-title">EDIT AREA</h2>
					...
					<div class="panel-body">
						...
						<div class="form-group">
							<label class="col-md-3 control-label" for="inputSuccess">Labor Name</label>
							<%@taglib uri="http://java.sun.com/jstl/core_rt" prefix="c"%>
							<div class="col-md-6">
								<select name="cStaffId" class="form-control mb-md">
									<c:forEach items="${sessionScope.cStaff }" var="x" >
													<c:if test="${y.cStaffRef.staffId eq x.staffId}">
												<option selected value="${x.staffId}"  selected="selected">${x.employeeName }</option>
												</c:if>
												
												<c:if test="${y.cStaffRef.staffId ne x.staffId}">
						...
						<div class="form-group">
							<label class="col-md-3 control-label" for="inputSuccess">Assign Area to Labour</label>
							<%@taglib uri="http://java.sun.com/jstl/core_rt" prefix="c"%>
							<div class="col-md-6">
					...
					<footer class="panel-footer">
						<div class="row">
							<input type="hidden" name="id" value="${y.cAssignAreaId}">
