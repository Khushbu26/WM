...
<body>
	<section class="body">
		...
		<div class="inner-wrapper">
			...
			<!-- end: sidebar -->
			<c:forEach items="${sessionScope.editarea }" var="y">
			<form action="<%=request.getContextPath()%>/AreaController" method="POST" name="areaForm">
				<section role="main" class="content-body">
						...
						<div class="form-group">
							...
							<div class="col-md-6">
								<input type="text" name="area" class="form-control"
									placeholder="Add Area" value="${y.areaName}" required />
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-md-6">
								<textarea name="area_des" class="form-control" rows="3"
									id="textareaAutosize" data-plugin-textarea-autosize>${y.areaDes}</textarea>
							</div>
						</div>
					...
					<footer class="panel-footer">
						<div class="row">
							<input type="hidden" name="id" value="${y.areaId}">
