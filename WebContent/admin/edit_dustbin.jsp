	...
	<section class="body">
		...
		<div class="inner-wrapper">
			...
			<%@taglib uri="http://java.sun.com/jstl/core_rt" prefix="c"%>
							<c:forEach items="${sessionScope.editdustbin }" var="x">
			...
			<section role="main" class="content-body">
				...
				<!-- hinal block start -->
										...
										<h2 class="panel-title">ADD DUSTBIN</h2>
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<input type="text" name="dustno" class="form-control"
								placeholder="Add dustbin number" value=" ${x.dustNo }" required />
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-md-6">
							<input type="text" name="dust" class="form-control"
								placeholder="Add dustbin name" value=" ${x.dustName }" required />
						</div>
					</div>
				...
				<footer class="panel-footer">
					<div class="row">
						...
						<input type="hidden" name="id" value="${x.dustId }">
