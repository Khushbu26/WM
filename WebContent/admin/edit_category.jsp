...
<%@taglib uri="http://java.sun.com/jstl/core_rt" prefix="c"%>
		...
		<div class="inner-wrapper">
			...
			<!-- end: sidebar -->
			<c:forEach items="${sessionScope.editcategory }" var="x">	
			...
			<section role="main" class="content-body">
				...
				<div class="panel-body">
					<div class="form-group">
						...
						<div class="col-md-6">
							<input type="text" value="${x.categoryName }" name="category" class="form-control"
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<textarea name="category_des" class="form-control" rows="3" id="textareaAutosize"
								data-plugin-textarea-autosize>${x.categoryDes }</textarea>
						</div>
					</div>
