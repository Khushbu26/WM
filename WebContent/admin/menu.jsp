									...
									<li class="nav-parent">
										...
										<ul class="nav nav-children">
											...
											<%System.out.println("in menu");%>
												<a href="<%=request.getContextPath()%>/ZoneController?flag=search">
													 Search Zone
												</a>
											</li>
											<%System.out.println("in menu");%>
										...
										<ul class="nav nav-children">
											<li>
												<a href="<%=request.getContextPath() %>/WardController?flag=load">
													 Add Ward
												</a>
											</li>
											<li>
