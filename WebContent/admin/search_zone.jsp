			...
			<section role="main" class="content-body">
				...
				<section class="panel">
					<header class="panel-heading">
						...
						<h2 class="panel-title">Search Zone</h2>
					</header>
								...
								<table
									...
									<%System.out.println("in search"); %>
										...
										<tr class="gradeX odd" role="row">
											...
											<td class="actions">
											<%System.out.println("in search"); %>
											<a href="<%=request.getContextPath() %>/ZoneController?flag=edit&id=${x.zoneId}" class="btn" rel="tooltip" title="Edit">
												 <i class="fa fa-pencil"></i>
											</a>
											<%System.out.println("in search"); %>
											<a href="<%=request.getContextPath() %>/ZoneController?flag=delete&id=${x.zoneId}" class="btn" rel="tooltip" title="Delete">
