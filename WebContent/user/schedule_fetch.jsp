		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="block col-sm-7 to_animate"
					...
					<thead>
					<tr>
						<th class="schedule_th text-center">Area</th>
						<th class="schedule_th text-center">Time</th>
				...
				<td class=" text-center">${x.areaRef.areaName}</td> 
				<td class=" text-center">${x.timePick}</td>
					</tr>
					 </c:forEach> 
										</tbody>
				</table>
