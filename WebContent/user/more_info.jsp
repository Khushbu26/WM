...
<div class="welcome_img"></div>
	...
	<p>Think Green® - When you have items that don't easily go out to the curb or into the recycling bin, Waste Management is ready to help.
Whether the unwanted item is as large as a refrigerator or as small as a syringe, we'll take it and responsibly manage it. Our strict environmental standards are the same as those used by the federal government.
</p>
