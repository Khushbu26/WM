...
import dao.UFileUploadDao;
import vo.UFileUploadVo;

@WebServlet("/UFileUploadServlet")
public class UFileUploadServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		UFileUploadVo fileUploadVo=new UFileUploadVo();
		UFileUploadDao fileUploadDao=new UFileUploadDao();
		...
		System.out.println(path1 + "hello");
		filePath = path1;
		...
		try {
			...
			while (i.hasNext()) {
				...
				if (!fi.isFormField()) {
					...
					/*
					 * String fieldName = fi.getFieldName(); String contentType
					 * = fi.getContentType(); boolean isInMemory =
			...
			/* Ends */
			response.sendRedirect(request.getContextPath() + "/user/file_upload.jsp");
		} catch (Exception ex) {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		/*
		 * throw new ServletException("GET method used with " + getClass(
